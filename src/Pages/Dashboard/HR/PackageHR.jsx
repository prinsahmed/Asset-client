      ...
      <div className="min-h-screen bg-slate-50  px-6 font-sans antialiased">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="mt-5 text-lg text-slate-600">
            Unlock advanced automation, real-time tracking, and priority
            support.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <CardAnimation
            ...
            className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col"
          >
            ...
            <button
              ...
              className="w-full py-4 rounded-xl font-bold border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white transition-colors duration-200"
            >
              Get Started
            </button>
          </CardAnimation>
          ...
          <CardAnimation
            ...
            className="relative bg-white rounded-3xl p-8 border-2 border-blue-600 shadow-2xl transform md:-translate-y-4 flex flex-col"
          >
            ...
            <button
              ...
              className="w-full py-4 rounded-xl font-bold bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all duration-200"
            >
              Upgrade Now
            </button>
          </CardAnimation>
          ...
          <CardAnimation
            ...
            className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col group"
          >
            <div className="flex justify-between items-start mb-6">
            ...
            <button
              ...
              className="w-full py-4 rounded-xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:opacity-90 transition-opacity duration-200 shadow-lg shadow-purple-900/20"
            >
              Go Unlimited
            </button>
          </CardAnimation>
