...
const Banner = () => {
    ...
    return (
        ...
        >
            <img src={bgImage} className="absolute inset-0 w-full h-full object-cover" alt="Banner Background" />

            <div className="absolute inset-0 bg-black/50 pt-36 pl-32 flex flex-col justify-start">
