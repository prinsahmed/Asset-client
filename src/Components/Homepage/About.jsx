            ...
            <div className='md:flex justify-center  gap-x-5 '>
                <div className="space-y-4">
                    ...
                    <CardAnimation
                        initial={{ opacity: 0, x: -20 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: .8, delay: 0.2 }} className="bg-white shadow-[0px_8px_24px_rgba(149,157,165,0.2)] rounded-xl p-6 md:ml-5">
                    ...
                    <CardAnimation
                        ...
                        className="bg-white shadow-[0px_8px_24px_rgba(149,157,165,0.2)] rounded-xl p-6 md:ml-10">
                        <div className='flex items-center gap-x-2'>
                    ...
                    <CardAnimation
                        ...
                        className="bg-white shadow-[0px_8px_24px_rgba(149,157,165,0.2)] rounded-xl p-6 md:ml-14">
                        <div className='flex items-center gap-x-2'>
                ...
                <div className='shadow-[0px_8px_24px_rgba(149,157,165,0.2)] rounded-xl pt-10 md:pt-0 p-6  md:p-6'>
                    <ul>
